...
// --- BİLEŞENLER ---
const CheckoutPage = ({ total, sepetiBosalt }) => {
  ...
  if (siparisTamamlandi) {
    return (
      <div style={{ backgroundColor: 'white', border: '4px solid #1a1a1a', padding: '40px', boxShadow: '12px 12px 0px #e2f0cb', maxWidth: '500px', margin: '40px auto', textAlign: 'center' }}>
        ...
        <p style={{ fontWeight: 'bold', color: '#555' }}>Sipariş numaranız: <strong>#VV-{Math.floor(100000 + Math.random() * 900000)}</strong></p>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '20px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
          <div>
            ...
            <input required type="text" style={{ width: '100%', padding: '10px', border: '2px solid #1a1a1a', marginTop: '5px', boxSizing: 'border-box' }} placeholder="Ahmet Yılmaz" />
          </div>
          <div>
            <label style={{ fontWeight: 'bold', fontSize: '0.85rem' }}>TELEFON</label>
            <input required type="tel" style={{ width: '100%', padding: '10px', border: '2px solid #1a1a1a', marginTop: '5px', boxSizing: 'border-box' }} placeholder="0555 111 22 33" />
          </div>
        </div>

        <div>
          <label style={{ fontWeight: 'bold', fontSize: '0.85rem' }}>TESLİMAT ADRESİ</label>
          <textarea required rows={3} style={{ width: '100%', padding: '10px', border: '2px solid #1a1a1a', marginTop: '5px', boxSizing: 'border-box', fontFamily: 'inherit' }} placeholder="Mahalle, Sokak, No, İlçe / İl" />
        </div>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px' }}>
        ...
        <div style={{ flex: '1 1 300px', minWidth: '300px' }}>
          <Routes>
            ...
            <Route path="/checkout" element={<CheckoutPage total={odenecekTutar} sepetiBosalt={sepetiBosalt} />} />
...
function App() {
  ...
  const plaklar = [
    { id: 1, ad: "Carry on Wayward Son", sanatci: "Kansas", fiyat: 450, kategori: "Rock", stok: 5 },
    { id: 2, ad: "Bohemian Rhapsody", sanatci: "Queen", fiyat: 600, kategori: "Rock", stok: 3 },
    { id: 3, ad: "Take Five", sanatci: "Dave Brubeck", fiyat: 550, kategori: "Jazz", stok: 8 },
    { id: 4, ad: "So What", sanatci: "Miles Davis", fiyat: 700, kategori: "Jazz", stok: 2 }
  ]
